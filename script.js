...
function mostrarInicio() {
    ...
    conteudo.innerHTML = `
        ...
        <section class="personagensInicio">
            ...
            <div
                class="personagensGrid"
                id="personagensInicioGrid"
            >
        ...
        <div class="fichaPersonagem">
            ...
            <div class="perfil">
                ...
                <div class="informacoes">
                    ...
                    <div class="estilosPersonagem">

                        <h3>Estilos</h3>

                        <p>
                            ${personagem.estilos || "Nenhum estilo definido."}
                        </p>
